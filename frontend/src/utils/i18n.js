        ...
        translation: {
            ...
            emailForm: {
                ...
                description: [
                    ...
                    '- Unsubscribe: click "Unsubscribe" button, enter the email, and a confirmation letter will be sent to your email address, click the corresponding link inside.',
        ...
        translation: {
            ...
            emailForm: {
                ...
                description: [
                    ...
                    '- 取消订阅：点击"取消订阅"按钮，输入邮箱，一封取消订阅确认信会发送至邮箱中，点击里面对应链接即可；',
