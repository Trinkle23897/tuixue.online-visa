...
if (strlen($_REQUEST['glob']) == 0) {
    ...
    $glob = ' --glob 1 ';
	$city = array('pp' => '金边', 'sg' => '新加坡', 'mel' => '墨尔本', 'per' => '珀斯', 'syd' => '悉尼', 'sel' => '首尔', 'brn' => '伯尔尼', "fuk" => "福冈", "itm" => "大坂", "oka" => "那霸", "cts" => "札幌", "hnd" => "东京", "ktm" => "加德满都", "bkk" => "曼谷", "cnx" => "清迈", 'bfs' => '贝尔法斯特', 'lcy'=> '伦敦', 'yyc'=> '卡尔加里', 'yhz'=> '哈利法克斯', 'yul'=> '蒙特利尔', 'yow'=> '渥太华', 'yqb'=> '魁北克城', 'yyz'=> '多伦多', 'yvr'=> '温哥华', 'auh'=> '阿布扎比', 'dxb'=> '迪拜', 'cdg' => '巴黎', 'beg' => '贝尔格莱德', "gye" => "瓜亚基尔", "uio" => "基多", "esb" => "安卡拉", "ist" => "伊斯坦布尔", "ath" => "雅典", "bog" => "波哥大", "bgi" => "布里奇顿",
		'cjs'=> '华雷斯城', 'gdl'=> '瓜达拉哈拉', 'hmo'=> '埃莫西约', 'cvj'=> '马塔莫罗斯', 'mid'=> '梅里达', 'mex'=> '墨西哥城', 'mty'=> '蒙特雷', 'ols'=> '诺加莱斯', 'nld'=> '新拉雷多', 'tij'=> '蒂华纳');
